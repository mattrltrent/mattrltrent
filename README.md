...
- Current interests: Search engine architectures, massively scalable Bzantine Fault Tolerant state machine replication (BFT SMR), & Zero Knowledge Proofs (zk-SNARKs).